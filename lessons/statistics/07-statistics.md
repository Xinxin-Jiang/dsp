...
>> p(identical|twin) = p(identical twin)/p(twin) = (1/300)/(1/125+1/300) = 0.294.
...
>> Bayesian requires the knowledge or an assumption on the prior probability distribution; while frequenting does not. 
